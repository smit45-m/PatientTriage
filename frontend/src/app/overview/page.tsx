...
export default function OverviewPage() {
    ...
    return (
      <main className="flex-1 flex items-center justify-center min-h-[60vh]">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-sm text-slate-400 font-medium">Loading clinical system...</p>
        </div>
      </main>
    );
  }
  ...
  return (
    <main className="flex-1 px-6 py-10 max-w-7xl mx-auto w-full space-y-16 relative overflow-hidden">
      ...
      <section className="space-y-8 pt-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 pt-2">
          ...
          <motion.div
            ...
            className="bg-white rounded-3xl p-6 border border-slate-200/80 border-t-[3px] border-t-purple-500 shadow-card flex flex-col space-y-4 hover:shadow-card-hover hover:border-purple-200 transition-all overflow-hidden relative group"
          >
      ...
      {/* ── Section 3: Indian Clinical Cohort Panoramic Banner ─────────── */}
      ...
      {/* ── Section 4: Timeline / Stages of Work ───────────────────────── */}
          ...
          <div className="lg:col-span-7 rounded-3xl bg-slate-50 p-6 border border-slate-200/80 flex flex-col justify-between space-y-6">
            ...
            <div className="grid grid-cols-3 gap-3 pt-2">
              <div className="p-3 bg-white rounded-2xl border border-slate-200 text-center">
                <span className="text-2xl font-black text-purple-800 gradient-text">100%</span>
                <p className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mt-0.5">ESI-1 Recall</p>
              </div>
              <div className="p-3 bg-white rounded-2xl border border-slate-200 text-center">
                <span className="text-2xl font-black text-emerald-700 gradient-text">0.9884</span>
                <p className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mt-0.5">Critical AUROC</p>
              </div>
              <div className="p-3 bg-white rounded-2xl border border-slate-200 text-center">
                <span className="text-2xl font-black text-indigo-700 gradient-text">208ms</span>
      ...
      {/* ── Section 6: Clinical Expert Panel ───────────────────────────── */}
      <section className="space-y-6 relative z-10">
        <div className="flex items-center justify-between">
          <div>
            <span className="text-xs font-bold tracking-widest text-slate-400 uppercase">
